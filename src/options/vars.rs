...
pub static EXA_ICONS_AUTO: &str = "EXA_ICONS_AUTO";

pub static EXA_STDIN_SEPARATOR: &str = "EXA_STDIN_SEPARATOR";
...
pub static EXA_WINDOWS_ATTRIBUTES: &str = "EXA_WINDOWS_ATTRIBUTES";
...
impl Vars for MockVars {
    fn get(&self, name: &'static str) -> Option<OsString> {
        match name {
            "EXA_STRICT" => Some(self.strict.clone()),
            "EXA_COLORS" | "LS_COLORS" => Some(self.colors.clone()),
            "EXA_DEBUG" => Some(self.debug.clone()),
            "EXA_GRID_ROWS" => Some(self.grid_rows.clone()),
            "EXA_ICON_SPACING" => Some(self.icon_spacing.clone()),
            "EXA_MIN_LUMINANCE" => Some(self.luminance.clone()),
            "EXA_ICONS_AUTO" => Some(self.icons.clone()),
...
impl MockVars {
    pub fn set(&mut self, var: &'static str, value: &OsString) {
        match var {
            "EXA_STRICT" => self.strict = value.clone(),
            "EXA_COLORS" | "LS_COLORS" => self.colors = value.clone(),
            "EXA_DEBUG" => self.debug = value.clone(),
            "EXA_GRID_ROWS" => self.grid_rows = value.clone(),
            "EXA_ICON_SPACING" => self.icon_spacing = value.clone(),
            "EXA_MIN_LUMINANCE" => self.luminance = value.clone(),
            "EXA_ICONS_AUTO" => self.icons = value.clone(),
