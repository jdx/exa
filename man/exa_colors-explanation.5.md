% exa_colors-explanation(5) $version

<!-- This is the exa_colors-explanation(5) man page, written in Markdown. -->
<!-- To generate the roff version, run `just man`, -->
<!-- and the man page will appear in the ‘target’ directory. -->

# Name

exa_colors-explanation — more details on customizing exa colors
...
- exa now supports bright colours! As supported by most modern 256\-colour terminals, you can now choose from `bright` colour codes when selecting your custom colours in your `#EXA_COLORS` environment variable.
...
Set `EXA_CONFIG_DIR` to specify which directory you would like exa to look for your `theme.yml` file,
otherwise exa will look for `$XDG_CONFIG_HOME/exa/theme.yml`.
